...
const articles = [
  {
    ...
    excerpt:
      'Arian Saeed Industrial Group Inc and Arian Leila opened Iran\'s first dedicated BYD showroom on Beheshti St., featuring the latest BYD models planned for the local market.',
    category: 'Automotive',
