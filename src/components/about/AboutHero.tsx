...
import { Building2, Users, Sparkles, Calendar } from 'lucide-react'
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900">
      ...
      <div className="container mx-auto px-4 relative z-10 pt-32 pb-20">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            {[
              { icon: Calendar, label: 'Established', value: '1982' },
              { icon: Building2, label: 'Companies', value: '32' },
              { icon: Users, label: 'Employees', value: '1,500+' },
            ].map((stat, index) => (
              <motion.div
                key={index}
                ...
                className="group relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10 hover:border-blue-400/50 hover:bg-white/10 transition-all duration-300"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-2xl" />
